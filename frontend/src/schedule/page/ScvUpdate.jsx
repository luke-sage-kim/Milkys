...
const ScvUpdate = () => {
    const { date, id } = useParams(); // 날짜와 수정할 투표 ID 받음
    ...
    const handleUpdate = async () => {
        ...
        try {
            const response = await fetch(`http://localhost:8080/scv/v1/${id}`, {
                method: 'PUT',
                headers: {
    ...
    return (
        <div className="max-w-2xl mx-auto p-6 bg-white rounded-lg shadow">
            <h2 className="text-2xl font-bold mb-6 text-center">{date} 일정 투표 수정</h2>
